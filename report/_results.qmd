...
![Boxplot diagrams of our main metrics for both static and motion conditions](Images/4-analysis-boxplot-tr-and-ntr.png){#fig-pilot fig-align="center"} 
...
Figure (TODO) shows the boxplots for our two main metrics for both participant groups. The results show, that there is a larger standard deviation in the static condition in group "Wolf" compared to group "Chicken". However, we can still identify the same trend that we saw in the global analysis, which is that the static conditon performs slightly better than the motion condtion.
