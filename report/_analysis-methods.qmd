...
At the beginning, we filtered out the data that was irrelevant for this research. The dropped columns can be seen in @lst-del:
...
With the resulting metrics for each subjects, the total average, mean and standard deviation is calculated, visualized in a boxplot and interpreted. <br>
